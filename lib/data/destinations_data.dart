...
List<DestinationsModel> destinationsData = [
  const DestinationsModel(
    ...
    duration: 1200,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/amakumo_peak.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des1',
    ...
    duration: 1800,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/chasm_underground.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des2',
    title: 'The Chasm',
    ...
    duration: 820,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/chasm.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des3',
    title: 'Dragonspine',
    ...
    duration: 984,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/dragonspine.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des4',
    title: 'Enkanomiya',
    ...
    duration: 2123,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/enkanomiya.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des5',
    title: 'Mt. Aocang',
    ...
    duration: 479,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/mt_aocang.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des6',
    title: 'Mt. Kanna',
    ...
    duration: 785,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/mt_kanna.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des7',
    title: 'Mt. Yougou',
    ...
    duration: 189,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/mt_yougou.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des8',
    title: 'Qingyun Peak',
    ...
    duration: 678,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/qingyun_peak.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des9',
    ...
    duration: 589,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/sangonomiya_shrine.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des10',
    title: 'Starfell Lake',
    ...
    duration: 120,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/starfell_lake.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des11',
    ...
    duration: 894,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/stormterror.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des12',
    title: 'Tatarasuna',
    ...
    duration: 685,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/tatarasuna.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des13',
    ...
    duration: 120,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/thousands_wind.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des14',
    title: 'Windrise',
    ...
    duration: 326,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/wind_rise.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des15',
    title: 'Wolvendom',
    ...
    duration: 249,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/wolvedome.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des16',
    title: 'Wuwang Hill',
    ...
    duration: 432,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/wuwang_hill.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des17',
    title: 'Mt. Aocang',
    ...
    duration: 236,
    imageUrl:
        'https://github.com/rezaageng/adventurers_guild/blob/main/assets/images/mt_aocang_cliff.png?raw=true',
  ),
  const DestinationsModel(
    id: 'des18',
    ...
    duration: 3534,
    imageUrl:
        'https://raw.githubusercontent.com/rezaageng/adventurers_guild/main/assets/images/golden_apple.webp',
  ),
];
